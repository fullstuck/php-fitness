		  ...
		  <div class="row">
			  ...
			  <div class="row">
                  <div class="col-lg-12">
					...
					<?php
					$noIdentitas = $_GET["kd"];
					$query = mysqli_query($koneksi, "SELECT * FROM tb_anggota WHERE no_identitas = '". $noIdentitas. "'");
					...
					<tbody>
					<tr>
                      <td><strong>Jenis Identitas</strong></td>
                      <td><strong><span class="label label-info"><?php echo $data['jenis_identitas']; ?></span></strong></td>
                      </tr>
                      <tr>
                      <td width="250"><strong>No. Identitas</strong></td>
                      <td width="565" colspan="1"><span class="label label-primary"><?php echo $data['no_identitas']; ?></span></td>
                      </tr>
                      <tr>
                      ...
                      <td colspan="1"><span class="label label-danger"><?php echo $data['tgl_lahir']; ?></span></td>
                      </tr>
					  <tr>
                      ...
                      <a href="anggota.php" class="btn btn-sm btn-primary"><i class="fa fa-arrow-circle-left"></i> Kembali </a>
					<!-- End -->
