		  ...
		  <div class="row">
              ...
              <!-- page start-->
					...
					<!-- Fungsi Menampilkan Data dari Database -->
							<?php
							$query = mysqli_query($koneksi, "SELECT * FROM tb_anggota WHERE id_anggota='$_GET[kd]'");
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
						  ...
						  <div class="panel-body">
                              <div class="form">
                                  <form class="form-horizontal style-form" action="update_anggota.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
								  <div class="form-group ">
                                          <label for="id_anggota" class="control-label col-lg-2">ID Anggota<span class="required">*</span></label>
                                          <div class="col-lg-1">
                                              <input class="form-control" id="id_anggota" name="id_anggota" type="text" value="<?php echo $data['id_anggota']; ?>" readonly="readonly" autofocus="on">
                                          </div>
                                      </div>
								  <div class="form-group">
									...
									<div class="form-group ">
                                          ...
                                          <div class="col-lg-3">
                                              <input class="form-control" id="no_identitas" name="no_identitas" type="text" value="<?php echo $data['no_identitas']; ?>">
                                          </div>
                                      </div>
									  <div class="form-group ">
                                          <label for="nama" class="control-label col-lg-2">Nama Anggota <span class="required">*</span></label>
                                          <div class="col-lg-4">
                                              <input class="form-control" id="nama" name="nama" type="text" value="<?php echo $data['nama']; ?>" />
                                          </div>
                                      </div>
									<div class="form-group ">
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-3">
                                              <input name="tgl_lahir" id="tgl_lahir" class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" type="text" value="<?php echo $data['tgl_lahir']; ?>" />  
										</div>
                                      </div>
									  <div class="form-group">
									  ...
									  <div class="form-group ">
                                          ...
                                          <div class="col-lg-2">
                                              <input class="form-control " id="no_hp" type="text" name="no_hp" value="<?php echo $data['no_hp']; ?>" />
                                          </div>
                                      </div>
                                      <div class="form-group">
