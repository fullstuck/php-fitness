			  ...
			  <!-- Fungsi Memasukkan Data kedalam Database -->
					<?php
						if(isset($_POST['input'])){
							...
							$cek = mysqli_query($koneksi, "SELECT * FROM tb_member WHERE no_card='$no_card'");
							if(mysqli_num_rows($cek) == 0){
									$insert = mysqli_query($koneksi, "INSERT INTO tb_member(no_card, id_anggota,
															id_kategori, tgl_daftar, tgl_expired, keterangan)
									VALUES('$no_card', '$id_anggota', '$id_kategori', '$tgl_daftar', '$tgl_expired', '$keterangan')") or die(mysqli_error());
									if($insert){
										echo '<div class="alert alert-info alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Data Member Berhasil Di Simpan.</div>';
									}else{
										echo '<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Ups, Data Member Gagal Di simpan !</div>';
									}
							}else{
                              ...
                              <div class="form">
                                  <form class="form-horizontal style-form" action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
									<div class="form-group ">
                                          ...
                                          <div class="col-lg-2">
                                              <input class="form-control" id="no_card" name="no_card" minlength="4" type="text" required />
                                          </div>
                                      </div>
									  <div class="form-group">
						  ...
						  <div class="form-group">
						    ...
						    <?php } ?>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-3">
                                              <input name="tgl_daftar" id="tgl_daftar" class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" type="text" placeholder="Tanggal Pendaftaran" required />  
										</div>
                                      </div>
									  <div class="form-group ">
                                          <label for="tgl_expired" class="control-label col-lg-2">Tanggal Expired <span class="required">*</span></label>
                                          <div class="col-lg-3">
                                              <input name="tgl_expired" id="tgl_expired" class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" type="text" placeholder="Tanggal Expired" required />  
										</div>
                                      </div>
                                      <div class="form-group ">
