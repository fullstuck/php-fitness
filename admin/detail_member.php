                  ...
                  <div class="col-lg-12">
                      <section class="panel">
						  ...
						  <!-- Fungsi Menampilkan Data dari Database -->
									<?php
									$kodeMember = $_GET["kd"];
									$query = mysqli_query($koneksi, "SELECT no_card, tb_anggota.nama, tb_kategori.nama_kategori, tgl_daftar, tgl_expired, keterangan
									FROM tb_member, tb_anggota, tb_kategori
									WHERE tb_member.id_anggota=tb_anggota.id_anggota AND tb_member.id_kategori=tb_kategori.id_kategori AND id_member = '". $kodeMember. "'");
					...
					<tr>
                      ...
                      <td><span class="label label-info"><?php echo $data['no_card']; ?></span></td>
                      </tr>
                      <tr>
                      <td width="250"><strong>Nama Member</strong></td>
                      <td width="565" colspan="1"><?php echo $data['nama']; ?></td>
                      </tr>
                      <tr>
                      <td><strong>Kategori</strong></td>
                      <td colspan="1"><strong><?php echo $data['nama_kategori']; ?></strong></td>
                      </tr>
                      <tr>
                      <td><strong>Tanggal Pendaftaran</strong></td>
                      <td colspan="1"><?php echo $data['tgl_daftar']; ?></td>
                      </tr>
					  <tr>
                      <td><strong>Tanggal Expired</strong></td>
                      <td colspan="1"><span class="label label-danger"><?php echo $data['tgl_expired']; ?></span></td>
                      </tr>
					  <tr>
                      ...
                      <a href="member.php" class="btn btn-sm btn-primary"><i class="fa fa-arrow-circle-left"></i> Kembali </a>
					<!-- End -->
