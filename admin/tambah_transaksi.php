			  ...
			  <!-- Fungsi Memasukkan Data kedalam Database -->
						...
						if(isset($_POST['input'])){
							...
							$user_id			= $_POST['user_id'];
									...
									$insert = mysqli_query($koneksi, "INSERT INTO tb_transaksi(id_member, id_kategori,
																		nama_anggota, pembayaran, tgl_transaksi, user_id)
																		VALUES('$id_member', '$id_kategori','$nama_anggota', '$pembayaran', '$tgl_transaksi', '$user_id')") 
																		or die(mysqli_error());
									if($insert){
										echo '<div class="alert alert-info alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Data Transaksi Berhasil Di Simpan.</div>';
									}else{
										echo '<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Ups, Data Transaksi Gagal Di simpan !</div>';
									}
                      ...
                      <section class="panel">
						  ...
						  <div class="panel-body">
                              ...
                              <?php
									...
									{
								?>
							<option value="<?php echo $data['id_anggota']; $id_anggota=$data['id_anggota']?>"><?php echo $data['no_card'];?></option>
						    <?php $jsArray .= "nama['" . $data['id_anggota'] . "'] = '" . addslashes($data['nama']) . "';\n";  } ?>
                              </select>
                              </div>
                          </div>
						  <div class="form-group">
						   ...
						   <div class="form-group ">
                                          ...
                                          <div class="col-lg-4">
                                              <input class="form-control " id="nama_anggota" type="text" name="nama_anggota" required readonly />
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-4">
                                              <input class="form-control " id="pembayaran" type="text" name="pembayaran" required readonly />
											  <script type="text/javascript">  
												<?php echo $jsArray1; ?>  
											   </script> 
                                          </div>
									  ...
									  <div class="form-group ">
                                          ...
                                          <div class="col-lg-3">
                                              <input name="tgl_transaksi" id="tgl_transaksi" class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" type="text" placeholder="Tanggal Lahir" required />  
										</div>
                                      </div>
                              <div class="form-group">
