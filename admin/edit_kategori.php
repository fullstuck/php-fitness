		  ...
		  <div class="row">
              ...
              <!-- page start-->
					...
					<!-- Fungsi Menampilkan Data dari Database -->
							<?php
							$query = mysqli_query($koneksi, "SELECT * FROM tb_kategori WHERE id_kategori='$_GET[kd]'");
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
						  ...
						  <div class="panel-body">
                              <div class="form">
                                  <form class="form-horizontal style-form" action="update_kategori.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
									<div class="form-group ">
                                          <label for="id_kategori" class="control-label col-lg-2">ID Kategori <span class="required">*</span></label>
                                          <div class="col-lg-1">
                                              <input class="form-control" id="id_kategori" name="id_kategori" value="<?php echo $data['id_kategori'];?>" readonly="readonly" autofocus="on"/>
                                          </div>
                                      </div>
									<div class="form-group ">
                                          <label for="nama_kategori" class="control-label col-lg-2">Nama Kategori <span class="required">*</span></label>
                                          <div class="col-lg-3">
                                              <input class="form-control" id="nama_kategori" name="nama_kategori" value="<?php echo $data['nama_kategori'];?>" type="text" required />
                                          </div>
                                      </div>
                                      <div class="form-group ">
                                          <label for="biaya" class="control-label col-lg-2">Biaya <span class="required">*</span></label>
                                          <div class="col-lg-2">
                                              <input class="form-control " id="biaya" type="text" value="<?php echo $data['biaya'];?>" name="biaya" required />
                                          </div>
                                      </div>
                                      <div class="form-group">
